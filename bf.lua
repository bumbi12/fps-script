shared.LoaderTitle = "TamPham On Top Baybeee";
...
local v15 = v14:CreateWindow({
    Title = "TamPham On Top Baybeee",
    SubTitle = "Github: bumbi12",
    TabWidth = 160,
    Theme = "Dark",
    Acrylic = false,
...
local v56 = v16.Main:AddSection("Cày Mas");
...
if Sea3 then
    local v498 = v16.Sea:AddSection("Đảo Kit");
    local v499 = v16.Sea:AddParagraph({
        Title = "Trạng Thái Đảo Kit",
        Content = ""
    });
    function UpdateKitsune()
        if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
            v499:SetDesc("Đảo Kit : ✅️");
        else
            v499:SetDesc("Đảo Kit : ❌️");
        end
    end
...
v16.Visual:AddInput("Input_Level", {
    Title = "Lvl",
    Default = "",
    Placeholder = "Nhập vào cấp muốn fake",
    Numeric = false,
    Finished = false,
...
v16.Visual:AddInput("Input_EXP", {
    Title = "Exp",
    Default = "",
    Placeholder = "Nhập vào kinh nghiệm muốn fake",
    Numeric = false,
    Finished = false,
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                if (v811 == 5) then
                    v561:SetDesc("LEVI NÓ SPAWN RỒI KÌA");
                elseif (v811 == 0) then
                    v561:SetDesc("Đếch biết :))");
                else
...
local v157 = v16.Sea:AddToggle("ToggleBlazeEmber", {
    Title = "Tự nhặt đốm lửa",
    Description = "LÀ ĐỐM LỬA ĐÓ NÍ",
    Default = false
});
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    Title = "Tự nhận quest đốm lửa",
    Description = "Bật Lên 1 Lần Là Nhận 1 Nhận Nữa Thì Tắt Bật Lại. Chịu thôi, đồ cùi mà Ní",
    Default = false
});
